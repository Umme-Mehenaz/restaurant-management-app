...
class BevrgLogin extends StatefulWidget {
  const BevrgLogin({super.key});

  @override
  State<BevrgLogin> createState() => _BevrgLoginState();
}

class _BevrgLoginState extends State<BevrgLogin> {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (c != null && (c.id == int.parse(_id.text))) {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => Beverage()));
              } else {
